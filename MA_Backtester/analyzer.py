...
class movingAverageCrossover:
    ...
    * Key-worded args :
    ...
    def analyse(self):
        ...
        forexFREDlist = pd.read_csv(os.path.dirname(os.path.realpath(__file__))+"/tickerLists/forex_tickers.csv", sep=";")
        ...
        for symbol in self.tickers:  # We begin the boucle that will iterate on every tickers
            ...
            cryptoTickerList = pd.read_csv(os.path.dirname(os.path.realpath(__file__))+"/tickerLists/crypto_tickers.csv", sep=";")
